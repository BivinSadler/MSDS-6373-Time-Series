...
f = fore.aruma.wge(AS2$Active.Users,phi = ARMA81$phi, theta = ARMA81$theta, n.ahead = 15,limits = T, lastn = T)
...
AS2_S7 = artrans.wge(AS2$Active.Users,c(rep(0,6),.6)) 
plotts.sample.wge(AS2_S7)
aic5.wge(AS2_S7, p = 1:10, q = 1:3)
aic5.wge(AS2_S7, p = 1:10, q = 1:3, type = "bic")
ARMA71 = est.arma.wge(AS2_S7,p = 7, q = 1)
AS2_S7_ARMA71 = artrans.wge(AS2_S7,phi.tr = ARMA71$phi)
ljung.wge(AS2_S7_ARMA71)
ljung.wge(AS2_S7_ARMA71, K = 48)

f = fore.aruma.wge(AS2$Active.Users,phi = ARMA71$phi, theta = ARMA71$theta, n.ahead = 15,limits = F, lastn = T)
